...
import frc.robot.Devices.Gyroscope;
import frc.robot.Devices.SparkMaxMotor;
import frc.robot.Devices.SwerveModule;

import frc.robot.Interface.Subsystem;
...
public class DriveBase implements Subsystem{
    ...
    public DriveBase() 
    {
        ...
        odometry = new SwerveDriveOdometry(
            kinematics,
            gyro.getAngleDegrees(), // returns current gyro reading as a Rotation2d
    ...
    public void update()
    {
        ...
        odometry.update(gyro.getAngleRotation(),  getCurrentSwerveModulePositions());
    }
